...
class Worker {
	...
	public void doWork() {
		...
		fetcher.fetchData(new FetchCallback() {
			public void onData(Data data) { // call if data is fetched without
											// error
				System.out.println("Data received: " + data);
			}

			public void onError(Throwable cause) { // call if error is received
													// during fetch
